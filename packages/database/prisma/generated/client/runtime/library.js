...
var Vo = {
  enabled:
    !Fo && Mo == null && $o !== "dumb" && ((oi != null && oi !== "0") || qo),
};
function F(e, r) {
  ...
  Ee = (e, r, t) => {
    ...
    if (ui(e)) {
      ...
      return Reflect.ownKeys(e).every((n) => {
        let i = e[n];
        return (
          (n in r || (Gt((o = i)) && o[Oe]().matcherType === "optional")) &&
          Ee(i, r[n], t)
        );
        var o;
      });
...
var Be = (e) =>
  ...
  Ue = (e) =>
    Object.assign(pe(e), {
      between: (r, t) =>
        Ue(q(e, ((n, i) => C((o) => je(o) && n <= o && i >= o))(r, t))),
...
var rn = (e, r = new vi()) => {
    ...
    return (
      e.getConnectionInfo &&
        (t.getConnectionInfo = Kc(r, e.getConnectionInfo.bind(e))),
      t
    );
  },
  Jc = (e, r) => ({
  ...
  toString() {
    let { config: r } = this,
      t = r.provider.fromEnvVar
        ...
        : r.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: t, binaryTargets: Zc(r.binaryTargets) }),
      );
...
m.precision = m.sd = function (e) {
  ...
  return (
    t.d ? ((r = Js(t.d)), e && t.e + 1 > r && (r = t.e + 1)) : (r = NaN),
    r
  );
};
m.round = function () {
...
function Zs(e) {
  ...
  function i(o) {
    ...
    if (l === "bigint")
      return (o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), fn(u, o.toString()));
    throw Error(He + o);
  }
  if (
    ((i.prototype = m),
...
function id(e) {
  var r,
    ...
    a = [];
  if (
    (e === void 0 ? (e = this.precision) : ie(e, 1, Ye),
    (n = Math.ceil(e / E)),
    this.crypto)
  )
  ...
  Et = class {
    constructor(r, t) {
      (to.set(this, { sql: r, values: t }),
        Object.defineProperty(this, $n, { value: $n }));
    }
    get sql() {
...
function $r(e = {}) {
  ...
  return Object.entries(r).reduce(
    (n, [i, o]) => (
      Va[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} },
  );
...
async function yl(e, r) {
  ...
  if (
    (tf("enginePath", n), n !== void 0 && e === "binary" && Ri(n), n !== void 0)
  )
...
\`\`\``
      : "",
    c = (0,
    po.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
    ...
    async handleError(r) {
      if (r instanceof pr)
        throw (
          ...
          new jr({ clientVersion: this.clientVersion, cause: r })
        );
      if (r) throw r;
    }
...
function Ef(e) {
  ...
  return (
    process.platform !== "win32" &&
      (i =
        xo.default.constants.dlopen.RTLD_LAZY |
        xo.default.constants.dlopen.RTLD_DEEPBIND),
...
var Po,
  $l = {
    async loadLibrary(e) {
      ...
      if (n === void 0)
        throw new v("WASM engine was unexpectedly `undefined`", r);
      Po === void 0 &&
        (Po = (async () => {
  ...
  async loadEngine() {
    if (!this.engine) {
      ...
      try {
        ...
        this.adapterPromise ||
          (this.adapterPromise = this.config.adapter?.connect()?.then(rn));
...
${a.backtrace}`,
  ...
  buildQueryError(r, t) {
    if (r.user_facing_error.is_panic)
      return new le(
        To(this, r.user_facing_error.message),
        this.config.clientVersion,
      );
    let n = this.getExternalAdapterError(r.user_facing_error, t);
    return n
      ? n.error
      : Mr(r, this.config.clientVersion, this.config.activeProvider);
  }
...
Expected string or undefined.`);
    ...
    omit: (e, r) => {
      if (typeof e != "object")
        throw new k('"omit" option is expected to be an object.');
